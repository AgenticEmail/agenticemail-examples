export function buildSystemPrompt(
	...
	return `You are a customer support agent. Your inbox is ${inboxEmail}.
...
3. If it is a bug or billing issue, gather the missing details in one reply, then escalate to ${escalationEmail} with a short summary.
